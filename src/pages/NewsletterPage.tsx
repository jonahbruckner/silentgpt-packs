      ...
      <section className="py-24 md:py-32">
        <div className="container max-w-2xl">
          <div className="text-center mb-12">
            <span className="section-label text-cyan-400 mb-4 block">Newsletter</span>
          ...
          <div className="mt-12 text-center">
            ...
            <div className="flex items-center justify-center gap-6 mt-6 text-sm text-muted-foreground/50">
