      ...
      <section className="py-24 md:py-32">
        <div className="container px-4 sm:px-6 lg:px-8 max-w-5xl">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4 mb-8">
            <div className="inline-flex rounded-2xl border border-border/50 bg-background/40 backdrop-blur-xl p-1">
              <button
                type="button"
              ...
              >
                FastAPI <span className="text-muted-foreground font-medium">({counts.fastapi})</span>
              </button>
              ...
              >
                Python Data <span className="text-muted-foreground font-medium">({counts.pydata})</span>
              </button>
            </div>

            <div className="text-sm text-muted-foreground text-center sm:text-right">
              Showing <span className="text-foreground font-semibold">{filtered.length}</span> posts
            </div>
          </div>
              ...
              return (
                ...
                >
                  <div className="flex items-center justify-between gap-4 mb-3">
                    <div className={cn("inline-flex items-center gap-2 text-xs font-semibold px-3 py-1 rounded-full border", topicBadgeClasses(post.topic))}>
                  ...
                  <div className="mt-4 inline-flex items-center gap-2 text-cyan-400 font-semibold text-sm">
                    Read article
